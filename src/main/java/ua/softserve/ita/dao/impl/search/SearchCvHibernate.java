...
//@Component("searchCvHibernate")
@Repository
@Slf4j
public class SearchCvHibernate {

    private SessionFactory sessionFactory;
    private Session session;

    @Autowired
    public SearchCvHibernate(SessionFactory sessionFactory) {
    ...
    public List<Person> searchByName(String searchText) {
        Query query = session.createQuery
                ("from person where first_name ILIKE :searchText OR last_name ILIKE :searchText"
                        , Person.class);
